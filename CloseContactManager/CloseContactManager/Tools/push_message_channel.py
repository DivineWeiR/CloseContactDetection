...
from CloseContactManager.lib.ChannelException import ChannelException

from CloseContactManager.lib.RequestCore import RequestCore
from CloseContactManager.lib.RequestCore import ResponseCore
from CloseContactManager.lib.valid import validOptDict
from CloseContactManager.lib.valid import nullOk
from CloseContactManager.lib.valid import validParam

from CloseContactManager.settings import BASE_DIR
...
class Channel(object):
    ...
    def _loadConf(self):
        ...
        try:
            ...
            # cp.read("/root/CloseContactManager/CloseContactManager/sdk.conf")
            cp.read(BASE_DIR + "/CloseContactManager/sdk.conf")
    ...
    def _commonProcess(self, paramOpt):
        ...
        if (ret.isOK()):
            result = json.loads(ret.body.decode("utf-8"))
            if (result is None):
